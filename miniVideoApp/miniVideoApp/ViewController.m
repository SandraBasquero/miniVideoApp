...
- (void)viewDidLoad {
    ...
    for (int i = 0; i < self.videoNamesArray.count; i++) {
        ...
        self.playerVideo.showsPlaybackControls = NO;
        [self.playerVideo.player play];
        self.playerVideo.player.muted = YES;
        self.playerVideo.view.userInteractionEnabled = NO;
...
- (IBAction)video1Action:(id)sender {
    ...
    self.playerVideo.player.muted = NO;
